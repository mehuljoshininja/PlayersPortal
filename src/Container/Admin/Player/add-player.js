...
class AddPlayer extends React.Component {
    ...
    onSubmit = (event) => { 
        ...
        // if(this.state.batsman.toLocaleLowerCase !== 'right' && this.state.batsman !== '-'){
        //     alert('Batting Style Must Be Conatin Only Right Or Left')
        //     return
        // }
        // if(this.state.bowler.toLocaleLowerCase !== 'right' && this.state.bowler !== '-'){
        //     alert('Bowling Style Must Be Conatin Only Right Or Left')
        //     return
        // }
